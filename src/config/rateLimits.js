...
export const RATE_LIMITS_AUTH = {
    loginUser: {window: 15 * 60 * 1000, max: 10, key: (req) => req.ip, message: "Too many login attempts, try after 15 minutes", },
    registerUser: {window: 15 * 60 * 1000, max: 5, key: (req) => req.ip, message: "Too many attempts, kindly slow down"},
